...
class SumoEnvironment(gym.Env):
    ...
    def __init__(
        ...
        print("tipo ts-ids" ,type(self.ts_ids))
        if isinstance(self.reward_fn, dict):
            ...
            for key, reward_fn_value in self.reward_fn.items():
                ...
                print(type("tipo reward se dict" ,self.reward_fn))
        else:
            print(type(self.reward_fn))
    ...
    def reset(self, seed: Optional[int] = None, **kwargs):
        ...
        self.vehicles = dict()
        print("seconda colonna :", self.traffic_signals['1'].reward_fn)
        print("quarta colonna:", self.traffic_signals['3'].reward_fn)
